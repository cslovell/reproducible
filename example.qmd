...
This document demonstrates the reproducible analysis button extension for Quarto. When rendered, it displays a prominent "🚀 Reproduce this analysis" button that launches a pre-configured JupyterLab environment on the UN Global Platform (Onyxia).
...
2. **Filename**: `ct_chile.qmd` → `ct_chile`
...
- ✅ Building immutable data artifacts
- ✅ Calculating SHA256 hashes
- ✅ Auto-committing hashes back to your `.qmd`
- ✅ Rendering the button in the published chapter
